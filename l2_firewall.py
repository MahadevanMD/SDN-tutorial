...
class l2Routing(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        if dpid == 1:
           ...
           self.add_flow(datapath, 1, parser.OFPMatch(eth_dst = '00:00:00:00:00:02'), [])

        elif dpid == 2:
           self.add_flow(datapath, 1, parser.OFPMatch(eth_dst = '00:00:00:00:00:03'), [parser.OFPActionOutput(2)])
